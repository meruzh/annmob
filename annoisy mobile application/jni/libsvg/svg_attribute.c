...
svgint_status_t _svg_attribute_get_double(const char **attributes,
...
svgint_status_t _svg_attribute_get_string(const char **attributes,
...
svgint_status_t _svg_attribute_get_length(const char **attributes,
		const char *name, svg_length_t *value, const char *default_value) {
	int i;
