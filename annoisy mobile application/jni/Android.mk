...
#include $(CLEAR_VARS)
#
##-I/lib/gcc/i686-pc-cygwin/4.3.4/include/c++ -I/lib/gcc/i686-pc-cygwin/3.4.4/include/c++/i686-pc-cygwin
##-I/cygdrive/e/www/stlport/stlport
##-I/lib/gcc/i686-pc-cygwin/4.3.4/include/c++ -I/lib/gcc/i686-pc-cygwin/3.4.4/include/c++/i686-pc-cygwin \
#
#LOCAL_MODULE    := libsvgagg
#LOCAL_CFLAGS += -DCONFIG_DIR=\"/\"  \
#-Ijni/libagg/agg/include/ -Ijni/libagg/agg/gpc/ -Ijni/libagg/aggsvg \
#-Ijni/libexpat/ -Ijni/libexpat/expat/ -DHAVE_CONFIG_H -DHAVE_EXPAT_CONFIG_H -Wall
#
## debugging
##LOCAL_CFLAGS += -DDEBUG_LIBSVG_ANDROID
#
